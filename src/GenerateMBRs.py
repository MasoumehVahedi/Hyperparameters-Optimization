...
class GenerateMBR:
    ...
    def generateSparseMBRs(self, x_min, x_max, y_min, y_max, MMS, scaled_SD_size):
    ...
    def generateMBRdataset(self, MDNN, SDNN, MMS, scaled_SD_size, x_min, x_max, y_min, y_max):
        ...
        bounding_boxes.extend(self.generateSparseMBRs(x_min, x_max, y_min, y_max, MMS, scaled_SD_size))
